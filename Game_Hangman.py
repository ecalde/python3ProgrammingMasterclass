import random
import Game_HangmanArt
import Game_HangmanWords

#To Do -1: - Update the word list to use the 'word_list' from hangman_words.py
chosen_word = random.choice(Game_HangmanWords.word_list)
...
while not end_of_game:
    ...
    print(Game_HangmanArt.stages[lives])